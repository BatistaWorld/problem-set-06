 ...
 * <tt>StdOut.class</tt> in your Java classpath. If you used our autoinstaller,
 * you should be all set. Otherwise, download
 * <a href = "http://introcs.cs.princeton.edu/java/stdlib/StdOut.java">StdOut.
 * java</a> and put a copy in your working directory.
 * <p>
 ...
 * </pre>
 * <p>
 * <b>Differences with System.out.</b> The behavior of <code>StdOut</code> is
 * similar to that of {@link System#out}, but there are a few subtle
 * differences:
 * <ul>
 * <li><code>StdOut</code> coerces the character-set encoding to UTF-8, which is
 * a standard character encoding for Unicode.
 * <li><code>StdOut</code> coerces the locale to {@link Locale#US}, for
 * consistency with {@link StdIn}, {@link Double#parseDouble(String)}, and
