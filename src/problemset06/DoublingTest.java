...
/**
 * The <tt>DoublingTest</tt> class provides a client for measuring the running
 * time of a method using a doubling test.
 * <p>
...
public class DoublingTest {
	...
	/**
	 * Prints table of running times to call <tt>ThreeSum.count()</tt> for
	 * arrays of size 250, 500, 1000, 2000, and so forth.
	 */
