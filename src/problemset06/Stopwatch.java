...
public class Stopwatch {
	...
	/**
	 * Unit tests the <tt>Stopwatch</tt> data type. Takes a command-line
	 * argument <tt>n</tt> and computes the sum of the square roots of the first
	 * <tt>n</tt> positive integers, first using <tt>Math.sqrt()</tt>, then
	 * using <tt>Math.pow()</tt>. It prints to standard output the sum and the
	 * amount of time to compute the sum. Note that the discrete sum can be
